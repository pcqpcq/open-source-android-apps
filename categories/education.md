...
| [**ForgetMeNot**](https://github.com/tema6120/ForgetMeNot) | A simple and user-friendly flashcard application for Android. | `Kotlin` | `GPL-3.0` | 417 | — |
...
| [**Oppia**](https://github.com/oppia/oppia-android) | An interactive learning app that enables users to create and share lessons. | `Kotlin` | `Apache-2.0` | 385 | — |
