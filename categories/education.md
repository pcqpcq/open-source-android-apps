...
| :--- | :--- | :---: | :---: | :---: | :---: |
| [**AnkiDroid**](https://github.com/ankidroid/Anki-Android) | A powerful, intelligent flashcard app that uses spaced repetition. | `Kotlin` | `GPL-3.0` | 11.3k | [![Google Play](https://upload.wikimedia.org/wikipedia/commons/7/78/Google_Play_Store_badge_EN.svg)](https://play.google.com/store/apps/details?id=com.ichi2.anki) |
...
| [**Oppia**](https://github.com/oppia/oppia-android) | An interactive learning app that enables users to create and share lessons. | `Kotlin` | `Apache-2.0` | 401 | — |
