...
| [**Super Productivity**](https://github.com/johannesjo/super-productivity) | An open-source to-do list and time tracker with timeboxing, Jira/GitHub/GitLab integration. | `TypeScript` | `MIT` | 18.0k | [![Google Play](https://upload.wikimedia.org/wikipedia/commons/7/78/Google_Play_Store_badge_EN.svg)](https://play.google.com/store/apps/details?id=com.superproductivity.superproductivity) |
