...
| [**Blazify**](https://github.com/rajendra7169/blazify) | A music player that streams online and plays the files already on your phone, with synced lyrics and a ten-band equalizer. | `Kotlin` | `GPL-3.0` | 31 | [![Download](https://img.shields.io/badge/Download-Releases-blue)](https://github.com/rajendra7169/blazify) |
...
| [**Kafka for Internet Archive**](https://github.com/vipulyaara/Kafka) | A modern client for Internet Archive with a built-in reader and audio player. | `Kotlin` | `GPL-3.0` | 395 | — |
...
| [**Vibe - Music Player**](https://github.com/fiedri/vibe-player) | Fast, minimalist local music player, 100% offline | `Svelte` | `GPL-3.0` | 6 | [![F-Droid](https://f-droid.org/badge/get-it-on.svg)](https://f-droid.org/packages/dev.fiedri.vibe) |
