...
| [**ad-free**](https://github.com/abertschi/ad-free) | A proof-of-concept modular audio ad-blocker for Android. | `Kotlin` | `Apache-2.0` | 297 | [![F-Droid](https://f-droid.org/badge/get-it-on.svg)](https://f-droid.org/packages/ch.abertschi.adfree) |
...
| [**Blazify**](https://github.com/rajendra7169/blazify) | A music player that streams online and plays the files already on your phone, with synced lyrics and a ten-band equalizer. | `Kotlin` | `GPL-3.0` | 26 | [![Download](https://img.shields.io/badge/Download-Releases-blue)](https://github.com/rajendra7169/blazify/releases) |
...
| [**Kafka for Internet Archive**](https://github.com/vipulyaara/Kafka) | A modern client for Internet Archive with a built-in reader and audio player. | `Kotlin` | `GPL-3.0` | 392 | — |
...
| [**NewPipe**](https://github.com/TeamNewPipe/NewPipe) | A lightweight, privacy-friendly YouTube frontend for Android. | `Java` | `GPL-3.0` | 39.6k | [![F-Droid](https://f-droid.org/badge/get-it-on.svg)](https://f-droid.org/packages/org.schabi.newpipe) |
...
| [**Nuvio**](https://github.com/NuvioMedia/NuvioMobile) | A modern media hub for Android and iOS built with Kotlin Multiplatform and Compose Multiplatform. | `Kotlin` | `GPL-3.0` | 3.3k | [![Google Play](https://upload.wikimedia.org/wikipedia/commons/7/78/Google_Play_Store_badge_EN.svg)](https://play.google.com/store/apps/details?id=com.nuvio.app) |
