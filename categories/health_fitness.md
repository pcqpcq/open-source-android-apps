...
| [**Pedometer**](https://github.com/j4velin/Pedometer) | A lightweight pedometer app that uses the hardware step-sensor. | `Kotlin` | `Apache-2.0` | 1.4k | — |
...
| [**trale**](https://github.com/QuantumPhysique/trale) | A simple and privacy-respecting body weight diary app built with Flutter. | `Dart` | `AGPL-3.0` | 219 | — |
