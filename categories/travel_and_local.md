...
| [**ForestMate**](https://github.com/spcx0701/forest-mate) | A hiking safety companion using forest public data: risk prediction, offline fallback, one-tap SOS, and a Wear OS companion. | `Kotlin` | `Apache-2.0` | 3 | [![Google Play](https://upload.wikimedia.org/wikipedia/commons/7/78/Google_Play_Store_badge_EN.svg)](https://play.google.com/store/apps/details?id=kr.forestmate.app) |
...
| [**NextGIS Mobile**](https://github.com/nextgis/nextgis_mobile_android) | A full-featured GIS application for creating and editing map data on the go. | `Java` | `GPL-3.0` | 143 | [![Google Play](https://upload.wikimedia.org/wikipedia/commons/7/78/Google_Play_Store_badge_EN.svg)](https://play.google.com/store/apps/details?id=com.nextgis.mobile) |
