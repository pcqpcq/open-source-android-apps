...
| [**Impeller**](https://github.com/erincandescent/Impeller) | A feature-rich client for the Pump.io open, federated social network. | `Java` | `Apache-2.0` | 48 | — |
...
| [**NewPipe**](https://github.com/TeamNewPipe/NewPipe) | A lightweight, privacy-friendly YouTube frontend for Android. | `Java` | `GPL-3.0` | 36.3k | — |
...
| [**Shadowsocks**](https://github.com/shadowsocks/shadowsocks-android) | A secure socks5 proxy client, widely used for bypassing network censorship. | `Kotlin` | `GPL-3.0` | 36.6k | [![Google Play](https://upload.wikimedia.org/wikipedia/commons/7/78/Google_Play_Store_badge_EN.svg)](https://play.google.com/store/apps/details?id=com.github.shadowsocks) |
