...
[SOPA](https://github.com/pongo710/sopa) |  SOPA is an Android puzzle game. The goal is to connect the green and the red gate with the blue tubes. Get better while solving the games level and enjoy playing. | Java | [![Get it on Google](https://i.imgur.com/T9HnFlW.png)](https://play.google.com/store/apps/details?id=de.sopa)
