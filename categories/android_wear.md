...
| [**AsteroidOS**](https://github.com/AsteroidOS/asteroid) | A free and open-source alternative operating system for smartwatches. | `Shell` | `GPL-2.0` | 939 | — |
| [**AsteroidOS Sync**](https://github.com/AsteroidOS/AsteroidOSSync) | The official sync client to connect your phone to an AsteroidOS watch. | `Java` | `GPL-3.0` | 102 | [![F-Droid](https://f-droid.org/badge/get-it-on.svg)](https://f-droid.org/packages/org.asteroidos.sync) |
